module.exports = [
    {
        ...
        squareDesc: 'Once again you begin your routine with a quick bath in whatever puddle you can find, and then it’s off to gather a hearty breakfast. The downtown city landscape is coming alive with busy humans who are certain to leave behind tasty treats for you to discover.',
        visitedDesc: 'You\'ve returned to last night\'s roost.'
    },
    {
        coords: {
            x: 1,
        ...
        visitedDesc: 'You\'ve returned to the riverfront where other crows squabble over scraps.'        
    },
    {
        coords: {
            x: -1,
        ...
        visitedDesc: 'You\'ve returned to the intersection with colorful lights.'
    },
    {
        coords: {
            x: 0,
        ...
        squareDesc: 'A rooftop garden tempts you down below, ripe green beans and plump, red tomatoes call your name. You\'ve been pondering for some time how to claim this paradise, but there is always a guardian over your desired feast. A great, big owl stands watch day and night, somehow never moving in the slightest. You\'re starting to suspect something unnatural about this sentinel, but you haven\'t built up the courage yet to investigate further.',
        visitedDesc: 'You\'ve returned to the garden with the watchful owl.'        
    },
    {
        coords: {
            x: 0,
        ...
        visitedDesc: 'You\'ve returned to the field.'        
    },
    {
        coords: {
            x: 1,
        ...
        visitedDesc: 'You\'ve returned to the human nest with the frantic starling.'        
    },
    {
        coords: {
            x: 1,
        ...
        visitedDesc: 'You\'ve returned to the street where another crow nabbed your breakfast.'        
    },
    {
        coords: {
            x: -1,
        ...
        visitedDesc: 'You\'ve returned to the neighboorhood picked clean by raccoons and squirrels.'        
    },
    {
        coords: {
            x: -1,
        ...
        visitedDesc: 'You\'ve returned to the perilous track.'        
    }
